...
public class Lockscreen extends JFrame {
	...
	public Lockscreen(final BufferedImage screenshot) {
		this.setTitle("Lockscreen");
	...
	public final void unlockAndClose() {
		...
		new Timer().schedule(new TimerTask() {
			...
			public final void run() {
				Lockscreen.this.setVisible(false);
	...
	public static final void main(final String[] args) throws HeadlessException, AWTException {
		final Lockscreen screen = new Lockscreen(new Robot().createScreenCapture(new Rectangle(Toolkit.getDefaultToolkit().getScreenSize())));
		screen.setVisible(true);
		new Timer().schedule(new TimerTask() {

			@Override
			public final void run() {
				screen.unlockAndClose();
			}
